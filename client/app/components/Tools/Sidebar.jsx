...
import { Row, Card, Icon, Dropdown, Modal, Button, Alert } from 'antd';
...
export default class Sidebar extends Component {
  ...
  showArchivedTaskList() {
    this.props.loadArchivedTasks(this.props.boardId);
    this.setState({
  ...
  render() {
    const { hideSidebar, archivedTasks, style } = this.props;
